    ...
    if (empty($email) || empty($password)) {
        ...
        if (login($email, $password)) {
            ...
            if (isBuyer()) {
                ...
                // Not a buyer account
                $error = 'This account does not have buyer privileges.';
                logout(); // Log them out
            }
        } else {
            // Invalid credentials
...
<head>
    ...
    <title>Buyer Login - <?php echo SITE_NAME; ?></title>
    <!-- Bootstrap CSS -->
    ...
    <main class="form-signin">
        <div class="card">
            <div class="card-header text-center py-3">
                <h2 class="h4 mb-0">Art Marketplace</h2>
            </div>
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    <img class="logo" src="<?php echo SITE_URL; ?>/assets/img/logo.png" alt="Logo">
                    <h1 class="h3 mb-3 fw-normal">Buyer Login</h1>
                </div>
